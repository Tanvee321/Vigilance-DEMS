    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
          ...
          <div className="glass-panel rounded-xl h-full p-6 flex flex-col justify-between shadow-2xl">
            <div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4 text-center px-4 select-none">
                  ...
                  <div>
                    <h3 className="font-display-lg text-base text-white tracking-wide uppercase font-bold">
                      {uploadedFile ? 'Forensic File Selected' : 'Drop Forensic Images or Text Files'}
                    </h3>
        ...
        <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <div className="glass-panel neon-border-blue rounded-lg p-6 flex flex-col gap-2 justify-between shadow-lg">
              ...
              <div className="bg-black/40 rounded-lg border border-white/5 px-4 py-2">
                <input 
                  ...
                  className="w-full font-data-mono text-white placeholder:text-[#c5c6cd]/20 focus:outline-none py-1 font-bold bg-transparent" 
            ...
            <div className="glass-panel neon-border-blue rounded-lg p-6 flex flex-col gap-2 justify-between shadow-lg">
              ...
              <div className="bg-black/40 rounded-lg border border-white/5 px-4 py-2">
                <input 
                  ...
                  className="w-full font-sans text-sm text-white placeholder:text-[#c5c6cd]/20 focus:outline-none py-1 font-bold bg-transparent" 
          ...
          <div className="glass-panel neon-border-blue rounded-lg p-6 flex flex-col gap-2 justify-between shadow-lg">
            <label className="font-label-caps text-[10px] text-[#c5c6cd] tracking-widest flex items-center gap-1 font-bold uppercase">
          ...
          <div className="glass-panel neon-border-blue rounded-lg p-6 flex flex-col gap-2 shadow-lg min-h-[200px]">
            <label className="font-label-caps text-[10px] text-[#c5c6cd] tracking-widest flex items-center gap-1 font-bold select-none">
              <span className="material-symbols-outlined text-sm">terminal</span> LIVE WEB-CRYPTO HASHING STREAM
            </label>
            <div className="bg-black/60 rounded border border-white/5 p-4 font-data-mono text-[11px] flex-grow space-y-1 h-36 overflow-y-auto custom-scrollbar">
        ...
        <div className="lg:col-span-10 mt-6">
          <div className="terminal-container rounded-xl border border-outline-variant p-4 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shrink-0">
            <div className="flex items-center gap-6">
              ...
              <div className="hidden md:flex flex-col font-data-mono text-[11px] text-[#c5c6cd]/50">
